...
var AppComponent = /** @class */ (function () {
    ...
    AppComponent.prototype.encerramentoJogo = function () {
        this.jogoEmAndamento = true;
...
var FRASES = [
    ...
    { fraseEng: 'I eat brad', frasePtBr: 'Eu como pão' },
];
...
module.exports = "<div class=\"container\">\n  <div class=\"jumbotron\">\n    \n    <div class=\"row\">\n      <div class=\"col-sm-6\"><app-progresso [progresso]=\"progresso\"></app-progresso>\n      </div>\n\n      <div class=\"col-sm-6\"><div class=\"d-flex justify-content-end\"><app-tentativas [tentativas]=\"tentativas\"></app-tentativas></div>\n      </div>\n    </div>\n\n    <div class=\"row\">\n      <div class=\"col\">\n        <h6>{{ instrucao }}</h6>\n        <p>{{ rodadaFrase.fraseEng }}</p>\n        <div class=\"form-group\">\n          <textarea\n            class=\"form-control\"\n            rows=\"3\"\n            (input)=\"atualizaResposta($event)\"\n            [value]=\"resposta\"         \n            placeholder=\"Digite aqui a sua resposta\"            \n          ></textarea>\n        </div>\n      </div>\n    </div>\n    <div class=\"row\">      \n        <div class=\"col\">\n          <div class=\"d-flex justify-content-end\">\n            <button type=\"button\" class=\"btn btn-dark btn-sm\" (click)=\"verificarResposta()\">Verificar</button>            \n          </div>   \n        </div>  \n      </div>\n  </div>\n</div>\n\n"
...
var PainelComponent = /** @class */ (function () {
    function PainelComponent() {
        ...
        this.instrucao = 'Traduza a frase a seguir:';
        this.resposta = "";
        this.rodada = 0;
        this.progresso = 0;
        this.tentativas = 3;
...
var Coracao = /** @class */ (function () {
    function Coracao(cheio, urlCoracaoCheio, urlCoracaoVazio) {
        if (urlCoracaoCheio === void 0) { urlCoracaoCheio = '/src/assets/coracao_cheio.png'; }
        if (urlCoracaoVazio === void 0) { urlCoracaoVazio = '/src/assets/coracao_vazio.png'; }
        this.cheio = cheio;
...
module.exports = __webpack_require__(/*! C:\Users\Hebert\Documents\GitHub\udemy\projetos\app1\src\main.ts */"./src/main.ts");
